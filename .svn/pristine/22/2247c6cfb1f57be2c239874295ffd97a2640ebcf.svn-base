...
//	      this.getType('3')//3店长
		...
		methods: {
			...
			getType(name,type){// 1:员工 2:销售主管 3:店长 4:城市经理 5:大区经理 6:零售助理7 大店长
				...
				console.log(type)
				that.$axios({
                    url: 'http://dvtest.qineasy.com:8888/employee/getManageList', 
                    method: 'post',
                    params: {
                    	jsonObject: {
                    		'type':type,
			...
			seachCity(areaId){
				var that = this
				that.$axios({
                    url: 'http://dvtest.qineasy.com:8888/store/getStoreCsList', 
                    method: 'post',
                    params: {
                    	jsonObject: {
                    		'areaId':areaId
			...
			saveEdit(obj){
				var that = this
				that.$axios({
                    url: 'http://dvtest.qineasy.com:8888/store/updateStore', 
                    method: 'post',
                    params: {
                    	jsonObject: {
